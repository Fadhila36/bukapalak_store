...
<?php $vtan=mysqli_query($con,"SELECT * FROM service where jawab='' order by id_service desc ");$mtan=mysqli_num_rows($vtan); ?>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">BukaPalak</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  BukaPalak - <?php echo $_SESSION['user']; ?>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="Zeon Storeuser.jpeg" class="img-circle" alt="User Image">
        </div>
        <div class="pull-left info">
          <p>BukaPalak - <?php echo $_SESSION['user']; ?></p>
...
?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="#">M. Fadhila A.F</a>.</strong> All rights
    reserved.
  </footer>
